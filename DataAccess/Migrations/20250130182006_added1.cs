    ...
    public partial class added1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikedProjects", x => new { x.UserId, x.ProjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Приложения, или сайтове, които съм напрвил", 1, "Програмиране" },
                    { 2, "Това са проекти, свързани със 3D моделиране и принтиране", 2, "3D моделиране" },
                    { 3, "Това са проекти, които използват техника, а може би и 3D моделиране", 3, "Електроника" },
                    { 4, "Интересни снимки, които съм правил наскоро", 4, "Фотография" },
                    { 5, "Опити за рисуване ; )", 5, "Рисуване" },
                    { 6, "Това са други проекти, които не съвпадат с другите категории", 6, "Други : )" }
                });
